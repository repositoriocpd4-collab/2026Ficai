---
description: Pesquisa e qualifica um prospect contra o ICP e cria uma nota persistente no pipeline.
---
...
Use como entrada o nome do negócio ou pessoa e o contexto fornecidos junto ao comando `/prospect-research`. Exemplo: `Clínica Sorriso São Paulo`.

Se o nome ou o contexto essencial estiverem ausentes, pergunte: "Qual o nome do negócio/pessoa e o contexto?"
