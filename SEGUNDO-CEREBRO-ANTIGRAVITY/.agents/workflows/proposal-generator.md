---
description: Gera e salva uma proposta personalizada para um prospect já pesquisado no pipeline.
---
...
Use como entrada o nome do prospect fornecido junto ao comando `/proposal-generator`, por exemplo `clinica-sorriso` ou `Clínica Sorriso`.

Se nenhum prospect for informado, pergunte: "Qual o nome do prospect? (deve ter nota em `_pipeline/`)"
