...
- `_memory/`, `_knowledge/`, `_learnings/`, `_decisions/`, `_pipeline/`, `_sessions/`, `_prompts/`, `.agents/workflows/`
- Se alguma estiver faltando, diga exatamente qual

### 4. Slash commands
- Liste todos os arquivos em `.agents/workflows/`
...
### 5. .agents/rules/segundo-cerebro.md
- Verifique se o .agents/rules/segundo-cerebro.md existe e está preenchido
- Verifique se a seção de identidade (Seção 2) tem dados reais ou ainda está com `[SEU NOME]`
- Verifique se a estrutura do vault no .agents/rules/segundo-cerebro.md reflete a estrutura real das pastas
...
| .agents/rules/segundo-cerebro.md | [Configurado / Pendente] | [o que falta] |
