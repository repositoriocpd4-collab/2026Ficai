...
## Passo 1: Preencher sua identidade na Rule principal

Abra `.agents/rules/segundo-cerebro.md` e vá até a **Seção 2 — Identidade**. Preencha os campos:
...
- Ferramentas principais: Figma, VS Code, Obsidian, Google Antigravity
...
- Ferramentas principais: VS Code, GitHub, Linear, Slack, Google Antigravity
...
- Ferramentas principais: IntelliJ, Obsidian, Google Docs, Google Antigravity
...
- Ferramentas principais: CapCut, Canva, Obsidian, Google Antigravity
- Stack técnico: N/A
```
...
- Ferramentas principais: Jira, Confluence, Slack, Obsidian, Google Antigravity
...
Se preferir que o Google Antigravity te ajude a preencher, use os prompts da pasta `_prompts/`:

1. Abra o workspace do Segundo Cérebro no Google Antigravity
2. Copie e cole o conteúdo do `_prompts/03-configurar-estado.md` no chat
3. O Antigravity vai ler o que você preencheu e gerar o estado inicial
...
2. No `.agents/rules/segundo-cerebro.md`, remova a **Seção 5 — Módulo negócios** inteira
3. Delete os comandos: `prospect-research.md`, `pipeline.md`, `proposal-generator.md` de `.agents/workflows/`
...
Crie um arquivo `.md` em `.agents/workflows/` com frontmatter YAML e as instruções do workflow:

```markdown
---
description: Descreva em uma frase quando e para que este workflow deve ser usado.
---
...
Use como entrada o contexto fornecido pelo usuário junto ao slash command.
...
Se renomear pastas ou arquivos, atualize as referências nos workflows e na Rule principal.
...
|-------|-------------|-------|
| 1 | Preencher identidade no .agents/rules/segundo-cerebro.md | 5 min |
